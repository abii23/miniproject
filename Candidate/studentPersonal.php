...
<div class="container" style="margin-left:93px; margin-bottom:10%;padding-left:130px; box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px; padding-top: 3%;">
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_housename" style="width:500px;" placeholder="Enter Student Name">
      </div>
    </div>
    <br>
    <div class="row">
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_Religion" style="width:500px;" placeholder="Enter Student Email" required>
      </div>
    </div>
    <br>
    <div class="row">
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_city" style="width:500px;" placeholder="Username" required>
      </div>
    </div>
    <br>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_pincode" style="width:500px;" placeholder="Username" required>
      </div>
    </div>
    <br>
